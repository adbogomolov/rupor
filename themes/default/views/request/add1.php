			...
			if (geoObject){
				if (!stop){
                    var map_geo = geoObject.properties.get('text');
                                                 ...
                                                 var map_geo_all;
                                                 //var parts_geo_itog[0] = '';
                                                 var map_geo_itog = '';
                                                 var parts_geo_itog;// = parts_geo[0];
                                                 map_geo_all = parts_geo[0];
                                                 var myGeocoder;
                                                 var street;
                                                 var j = 1;
                                                 var j_max = parts_geo.length;
                                                 ...
                                                 myGeocoder = ymaps.geocode(map_geo_all);
                                                 myGeocoder.then(
                                                                 function (res) {
                                                                 ...
                                                                 if (map_geo_itog == '') {
                                                                    map_geo_itog = map_geo22;
                                                                 } else {
                                                                    map_geo_itog = map_geo_itog + ',' + map_geo22;
                                                                 }
