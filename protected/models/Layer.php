...
class Layer extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, url, created', 'required'),
			array('name, url', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, name, url, created', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'officerLayers' => array(self::HAS_MANY, 'OfficerLayer', 'layer_id'),
			'tags' => array(self::HAS_MANY, 'Tag', 'layer_id'),
			'tagLayers' => array(self::HAS_MANY, 'TagLayer', 'layer_id'),
		);
	}
